...
router.get('/seating', validate(schema.seatingQuery, 'query'), async (req, res, next) => {
  try {
...
router.get('/registration', validate(schema.registrationQuery, 'query'), async (req, res, next) => {
  try {
