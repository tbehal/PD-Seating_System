  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onSearch(); }} className="space-y-4">
      <div>
        ...
        <select id="startWeek" name="startWeek" value={criteria.startWeek} onChange={onInputChange}
      ...
      <div>
        ...
        <select id="endWeek" name="endWeek" value={criteria.endWeek} onChange={onInputChange}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm">
          {Array.from({ length: 12 }, (_, i) => i + 1).map(week => (
      ...
      <div>
        ...
        <input type="number" name="weeksNeeded" id="weeksNeeded" value={criteria.weeksNeeded} onChange={onInputChange}
          className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-brand-500 focus:ring-brand-500 sm:text-sm" min="1" />
      </div>
